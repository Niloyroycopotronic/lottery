...
<div class="content-wrapper">
  ...
  <div class="row">
     <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Reg Add</h4>
                
                    <form class="forms-sample" method="post" action="{{ route('reg.store') }}">
                        @csrf
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Reg List</h4>
                            {!! displayAlert() !!}
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('reg.destroy', $volt->id ) }}" method="POST">
                                    @csrf
                                    @method('delete')
